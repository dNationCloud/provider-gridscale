...
func (mg *StorageBucket) GetTerraformResourceType() string {
	return "gridscale_object_storage_bucket"
}
...
// GetInitParameters of this StorageBucket
func (tr *StorageBucket) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this StorageBucket
func (tr *StorageBucket) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
