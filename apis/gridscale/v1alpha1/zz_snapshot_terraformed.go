...
func (mg *Snapshot) GetTerraformResourceType() string {
	return "gridscale_snapshot"
}

// GetConnectionDetailsMapping for this Snapshot
func (tr *Snapshot) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"object_storage_export[*].access_key": "objectStorageExport[*].accessKeySecretRef", "object_storage_export[*].secret_key": "objectStorageExport[*].secretKeySecretRef"}
}
