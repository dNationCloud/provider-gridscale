...
func (mg *Certificate) GetTerraformResourceType() string {
	return "gridscale_ssl_certificate"
}

// GetConnectionDetailsMapping for this Certificate
func (tr *Certificate) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"certificate_chain": "certificateChainSecretRef", "leaf_certificate": "leafCertificateSecretRef", "private_key": "privateKeySecretRef"}
}
